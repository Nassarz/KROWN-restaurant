-- ============================================================================
-- PRODUCTION-GRADE POSTGRESQL RELATIONAL SCHEMA & REALTIME MIGRATION
-- File: supabase/migrations/20260801_production_relational_schema.sql
-- Run this script in the Supabase SQL Editor to establish Foreign Keys & Realtime
-- ============================================================================

-- 1. COMPANIES TABLE (CORPORATE CLIENT ACCOUNTS & HQ REGISTRY)
...
-- 2. BRANCHES TABLE (FOREIGN KEY TO COMPANIES)
...
-- 3. COMPANY STAFF TABLE (FOREIGN KEY TO COMPANIES)
...
-- 4. STAFF TABLE (FOREIGN KEYS TO BRANCHES & COMPANIES)
...
BEGIN;
  ...
  CREATE PUBLICATION supabase_realtime FOR TABLE 
    companies, company_staff, branches, staff, zones, products, ingredients, orders, expenses, accounting_ledger, audit_logs;
COMMIT;

-- 13. SEED PRIMARY SUPER ADMIN ACCOUNT (ID: cd91de98-cfc5-4246-a44a-fc09af98a23d)
...
-- ============================================================================
-- END OF PRODUCTION RELATIONAL SCHEMA MIGRATION SCRIPT
-- ============================================================================
